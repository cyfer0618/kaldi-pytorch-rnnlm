...
int main(int argc, char *argv[]) {
  try {
    ...
    using namespace kaldi::py_rnnlm;
    ...
    // Changed *****
    KaldiPyRnnlmWrapper rnnlm(opts, rnn_word_list, word_symbols_rxfilename,
    ...
    for (; !compact_lattice_reader.Done(); compact_lattice_reader.Next()) {
      ...
      if (lm_scale != 0.0) {
        ...
        // Changed *****
        PyRnnlmDeterministicFst rnnlm_fst(max_ngram_order, &rnnlm);
